...
class ModCIFAR100(ContinualDataset):
    NAME = 'mod-cifar100'
    SETTING = 'class-il'
    ...
    def __init__(self, args):
        ...
        train_embedding_path, val_embedding_path = "../cifar100_train_embedding.pt", "../cifar100_test_embedding.pt"
    ...
    @staticmethod
    def get_backbone():
        return SimpleMLP(input_size=768, output_size=100)
    ...
    def get_minibatch_size():
        return ModCIFAR100.get_batch_size()
