...
class Appr(Inc_Learning_Appr):
    ...
    def compute_mean_of_exemplars(self, trn_loader, transform):
        ...
        with override_dataset_transform(self.exemplars_dataset, transform) as _ds:
            ...
            with torch.no_grad():
                self.model.eval()
                # print(dir(icarl_loader))
                # print(icarl_loader.batch_size)
                # print(icarl_loader.batch_sampler)

                # for inputs, targets in icarl_loader:
                #     print(inputs)
                ...
                for images, targets in icarl_loader:
                    ...
                    # print(feats.size())
                    if len(feats.size()) == 1:
                        extracted_features.append(feats / feats.norm())
                    else:
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        if t > 0:            
            ...
            # print(dir(trn_loader.dataset))
            # print(type(trn_loader.dataset.inputs))
            # print(type(trn_loader.dataset.inputs[0]))
            # print(trn_loader.dataset.inputs[0].shape)
            # print(type(trn_loader.dataset.labels))
            # print(trn_loader.dataset.transform)
            # print()
            # print(type(self.exemplars_dataset))
            # print(dir(self.exemplars_dataset))
            # print(type(self.exemplars_dataset.images))
            # print(self.exemplars_dataset.images.shape)
            # print(self.exemplars_dataset.transform)
            # exit()
    ...
    def train_epoch(self, t, trn_loader):
        ...
        # if t > 0:
        #     print(dir(trn_loader.dataset.datasets))
        #     print(type(trn_loader.dataset.datasets))
        #     print(type(trn_loader.dataset))
